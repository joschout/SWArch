...
\begin{itemize}
    \item \textbf{Summary:} Intiated by Time, the system sends an e-mail to an Unregistered recipient.
    ...
    \item \textbf{Postconditions:}
        \begin{itemize}
            \item The System has send out an e-mail address to the Unregistered recipient.
        \end{itemize}
...
\begin{itemize}
    \item \textbf{Summary:} After receiving an error message from an e-mail provider, the System noifies the customer organization about the incorrect addressing information.
...
\begin{itemize}
    ...
    \item \textbf{Alternative scenarios:} 
    \begin{enumerate}
        \item [3a.] If receipt tracking is enabled:
        \begin{enumerate}
