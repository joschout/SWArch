...
\begin{itemize}
    ...
    \item \textbf{Alternative scenarios:} 
    \begin{enumerate}
        \item [2a.] Erronous data is sent back to the customer organisation from which it originated
        \item [3a.] The customer organisation corrects the erronous part(s) of the respective (batch of) raw data
