...
\begin{itemize}
    \item \textbf{Customer organization client}: a Reciever of invoices send by a Customer organization
    \item \textbf{Archive}: definition
    \item \textbf{Metadata}: part of the raw data that specifies the addressing method and address for a specific Recipient.
\end{itemize}
...
\subsection{\emph{UC1}: Consult document status}
\begin{itemize}
...
\subsection{\emph{UC9}: Enable receipt tracking}
\begin{itemize}
...
\subsection{\emph{UC10}: Disable receipt tracking}
\begin{itemize}
...
\subsection{\emph{UC11}: Send document via e-mail}
\begin{itemize}
...
\subsection{\emph{UC12}: Notify about incorrect e-mail address}
\begin{itemize}
...
\end{itemize}
\subsection{\emph{UC13}: Receive document via e-mail}
\begin{itemize}
...
\subsection{\emph{UC14}: Search for document in personal document store}
\begin{itemize}
...
\subsection{\emph{UC15}: Send document via print \& postal service}
\begin{itemize}
