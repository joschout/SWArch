...
In this scenario, we illustrate the internal behaviour for our system  for the most important data flows, i.e. the authentication of the Registered Recipients and the whole document processing flow.\\
...
The document processing flow is covered over multiple sections. The initiation of the document processing by the delivery of raw data is explained in section \ref{scenario:InitiateDocProcessing}. Section \ref{scenario:DocumentGeneration} recaps the generation of documents as already explained in the initial architecture, but adapts it to the extended architecture. Section \ref{scenario:DeliverDoc} and its subsections describe the different ways how a document can be delivered.\\
