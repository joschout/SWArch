...
Responsible for storing a partition of the documents in the \texttt{DocumentDB}. This component actually represents multiple instances, each containing a different partition of the document data to accommodate for parallel lookups in different partitions while minimizing storage costs.
...
Describe the decomposition of \texttt{DeliveryFunctionality} and how this relates to the
requirements.
