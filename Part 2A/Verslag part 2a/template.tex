...
Av1 also requires documents to be generated and delivered exactly once. This is accomplished by the \texttt{DocumentGenerationScheduler} overseeing all processing jobs and
