...
There are four use cases about the delivery of documents. These are thus selected as the functional drivers. These use cases are:
...
\paragraph{Rationale}
P2 was chosen because it concerns the performance of the document store as a delivery channel. This requirement has medium priority since document delivery is a central aspect of the system.
