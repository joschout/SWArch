...
The failure of the components monitored by the \textt could also be done using a \textbf{heartbeat}. But this would require both the monit
...
\subparagraph{AuthenticationFunctionality}
